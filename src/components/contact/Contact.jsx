    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact_container container grid">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                abhishekcha790@gmail.com
              </span>

              <a
                href="mailto:abhishekcha790@gmail.com"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">+91 8052790809</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">facebook</span>
        ...
        <div className="contact_content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact_for">
